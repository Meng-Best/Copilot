...
class ApiPlanningHub:
    ...
    def single_api_planning(self, query, raw_query=""):
        """
        ...
        if tool is None:
            ...
            params, missing_params = self.paramExtractionHub.extraction_params(query + " " + raw_query, tool)
    ...
    def apis_planning(self, query, task_id):
        ...
        def process_single_api_invoke(curr_task_desc):
            api_invoke_result = self.single_api_planning(curr_task_desc, raw_query)
